...
export const businessOnboardingService = {
  ...
  suspendBusiness: (adminUserId: number, applicationId: number, reason: string) => legacyBusiness.suspendBusinessWorkspace(adminUserId, applicationId, reason),
  restoreBusiness: (adminUserId: number, applicationId: number) => legacyBusiness.restoreBusinessWorkspace(adminUserId, applicationId),
};
